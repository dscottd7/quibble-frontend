  ...
  return (
    <Center>
      <Box maw="1200px" ml="10px" mr="10px" >
        <Grid gutter={{ base: 20, xs: 40, md: 60, xl: 80 }}>
          <Center>
          {/* single column - Quibble tagline */}
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Space h="sm" />
            <Title mb="20px" c="cyan" order={1}>Make smarter decisions—compare, choose, and save time with Quibble.</Title>
          ...
          {/* left col on desktop, single on mobile - tech stack description + images */}
          ...
          <Stack align="center">
            ...
            <Text c="dimmed">Quibble Architecture</Text>
          </Stack>
          <Space h={75} />
          <Stack align="center">
            <Image src="/deployment.png" alt="logo" maxWidth="100%" />
            <Text c="dimmed">Backend Deployment to Google Cloud Run</Text>
          </Stack>
          <Space h={25} />
          </Grid.Col>
          
          {/* right col on desktop, single on mobile - github + docker + team cards */}
          <Grid.Col span={{ base: 12, md: 6 }}>
